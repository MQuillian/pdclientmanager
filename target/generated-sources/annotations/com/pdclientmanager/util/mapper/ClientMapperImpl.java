...
public class ClientMapperImpl implements ClientMapper {
    ...
    @Override
    public ClientDto toClientDto(Client entity, CycleAvoidingMappingContext context) {
        ClientDto target = context.getMappedInstance( entity, ClientDto.class );
        if ( target != null ) {
            return target;
        }
        ...
        context.storeMappedInstance( entity, clientDto );

        clientDto.setId( entity.getId() );
        clientDto.setName( entity.getName() );
        clientDto.setCustodyStatus( entity.getCustodyStatus() );
        clientDto.setCases( caseListToCaseMinimalDtoList( entity.getCases(), context ) );
    ...
    @Override
    public List<ClientDto> toClientDtoList(List<Client> entities, CycleAvoidingMappingContext context) {
        List<ClientDto> target = context.getMappedInstance( entities, List.class );
        if ( target != null ) {
            return target;
        }
        ...
        for ( Client client : entities ) {
            list.add( toClientDto( client, context ) );
        }
