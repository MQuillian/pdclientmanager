...
public class CaseForm {
    ...
    public CaseForm(Long id, String caseNumber, String dateOpened, String dateClosed,
    ...
    public static class CaseFormDtoBuilder {
        ...
        public CaseForm build() {
            return new CaseForm(id, caseNumber, dateOpened, dateClosed,
